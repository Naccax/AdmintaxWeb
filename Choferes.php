...
?>
    ...
    <div class="container text-center abs-center">
        ...
        <b>Horas extra: </b> <?php if ($todosLosChoferes[$id]["HsExtra"]) { echo "Sí"; }else{ echo "No"; } ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    foreach($planillaDeTrabajo as $row)
    {
        ...
        }else
        {
            ...
            {
                if(str_contains($row['Concepto'], "Licencia") or str_contains($row['Concepto'], "Vacacional"))
                {
    ...
    <div class="container text-center abs-center">
        ...
        <table width="100%"> 
            ...
            <?php
            foreach($salarioVacacionalyLicencia as $row)
            {
                echo "<tr>";
                $temp=explode("-",$row['Fecha']);
                echo "<td>";
