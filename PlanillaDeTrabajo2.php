...
$sql = "SELECT * FROM `planilladetrabajofueradenomina` WHERE Fecha > '".date("Y-m-d",$inicio)." 23:59:59' AND Fecha < '".date("Y-m-d",$fin)." 00:00:00' AND EmpresaID ='$empresaID' AND Concepto = 'Recibo Sueldo'";
//echo "$sql";
...
//print_r($planilladetrabajofueradenomina);
//echo " " . $fecha[0];
$meces["01"]="Enero";
$meces["02"]="Febrero";
$meces["03"]="Marzo";
...
<td width='25'></td>
  <td class="titulo" border="1" aling="center"><b>
    <p> <a href="ResumenDeEmpresa.php">ADMINTAX</a> 
  </td>
<td width='15'>
</td>
...
<br>
  ...
  <table class="table" border="1">
    ...
    <td rowspan='3' width='187'><b>Nombre Completo</td><td rowspan='3'><b>Recau-<br>dación<br>Total</td><th colspan="8">Jornales Horas y Montos por tipo de día </td><td colspan="2" rowspan='2'><b>Feriados<br>No laborable<br>No trabajados </td><td rowspan='2' colspan="2"><b>Jornales no trab. <br>por causas no<br>imputables al<br>trabajador</b></td><td rowspan='3'><b>Partici-<br>pación</b></td><td rowspan='3'><b>Remun-<br>eración<br>Total</b></td>
    ...
    <?php 
        foreach($planilladetrabajofueradenomina as $row)
        {
        ...
        echo "<tr><td colspan='2' class='tot'><b>Recaudación total:</td><td>".$recaudacion."</td></tr>";
    ?>
