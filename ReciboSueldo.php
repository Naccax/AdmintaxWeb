...
<table border="1" calss="ex">
    ...
    <td colspan="2">
        ...
        <br><b>Cédula de Identidad:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <?php echo $choferes[$_GET["CHID"]]['ci']; ?>
        <br><b>Fecha de Ingreso: </b><?php echo $choferes[$_GET["CHID"]]['FechaDeIngreso']; ?><b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<br>Antigüedad: </b><?php echo $choferes[$_GET["CHID"]]['FechaDeIngreso']; ?>
        <br><b>Cargo:</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; CHOFER
