...
if (isset($_POST['ChoferID']) && isset($_POST['EmpresaID']) && isset($_POST['fecha']) && isset($_POST['TotalBruto'])){
  ...
  $sql="SELECT * FROM planilladetrabajo WHERE Fecha='".$_POST["fecha"]."' AND Concepto='Aguinaldo' AND ChoferID='".$_POST["ChoferID"]."' AND EmpresaID='".$_POST["EmpresaID"]."';";
  ...
  <table border="1" calss="ex">
      <tr>
      <td colspan="3"> <B>AdminTax | &nbsp; LIQUIDACIÓN CORRESPONDIENTE AGUINALDO <?php echo $reciboFecha;?></td><td class="cons"><b>RECIBO DE AGUINALDO</td>
      </tr>
      <tr>
      <td width='48%'>
