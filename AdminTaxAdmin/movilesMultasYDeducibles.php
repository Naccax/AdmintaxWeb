...
if (isset($_POST["Mostrar_Todos"]))
    $consulta="SELECT * FROM multas,chofer where chofer.id=multas.chofer";
else
    $consulta="SELECT * FROM multas,chofer where Estado!='Paga' and chofer.id=multas.chofer";
        ...
        <tbody>
            <?php
                foreach($todosLosMoviles as $row)
                {
                    ...
                    {
                        echo '
                        <form action="multaGuardarCambios.php" method="POST">
                        <input type="text" name="id" value="'.$row[0].'" hidden>
                        <input type="text" name="chofer" value="'.$row['chofer'].'" hidden>
                        <input type="text" name="choferNombre" value="'.$row['Nombre'].'" hidden> 
                        <input type="text" name="movil" value="'.$row['movil'].'" hidden>
                        <input type="text" name="Motivo" value="'.$row['Motivo'].'" hidden>
                        <input type="text" name="detalle" value="'.$row['detalle'].'" hidden>
                        <input type="text" name="Estado" value="'.$row['Estado'].'" hidden>
                        <input type="text" name="fecha" value="'.$row['fecha'].'" hidden>
                        <input type="text" name="monto" value="'.$row['monto'].'" hidden>
                        <input type="text" name="MontoEnUR" value="'.$row['MontoEnUR'].'" hidden>
                        <input type="text" name="saldo" value="'.$row['saldo'].'" hidden>
                        <input type="text" name="Entregado" value="'.$row['Entregado'].'" hidden>
                        <input type="text" name="MovilId" value="'.$row['MovilId'].'" hidden>
                    ...
                    else
                    {
                        ...
                        {
                            echo '
                            <form action="multasEntregas.php" method="POST">
                            <input type="text" name="multa" value="'.$row[0].'" hidden>
                            <input type="text" name="choferNombre" value="'.$row['Nombre'].'" hidden> 
                            <input type="text" name="chofer" value="'.$row['chofer'].'" hidden>
                            <input type="text" name="movil" value="'.$row['movil'].'" hidden>
                            <input type="text" name="MovilId" value="'.$row['MovilId'].'" hidden>
                            ...
                            <input type="text" name="saldo" value="'.$row['saldo'].'" hidden>
                            <input type="text" name="Entregado" value="'.$row['Entregado'].'" hidden>
                            <input type="submit" name="Entregas" value="Entregas" class="btn btn-secondary">
                            </form>
                            ';
                        }
                        else
