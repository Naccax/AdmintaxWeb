...
$sql="SELECT * FROM planilladetrabajo WHERE Fecha='".$_POST["fecha"]."' AND Concepto like '%Licencia%' AND ChoferID='".$_POST["ChoferID"]."' AND EmpresaID='".$_POST["EmpresaID"]."' and Id='".$_GET["rsid"]."';";
...
if($recibo[0]["LicenciaGozada"] == "No")
{
  $descuntoJuvilatorio=0;
}
...
$sql="UPDATE planilladetrabajo SET TotalRecibido=`TotalBruto`-'".$totalRetenido."' WHERE Id='".$_GET["rsid"]."' and LicenciaGozada='No';";
Insert($sql);
...
$sql="UPDATE planilladetrabajo SET Descuentos='".$totalDescuentos+$totalRetenido."' WHERE Id='".$_GET["rsid"]."';";
Insert($sql);
...
<table border="1" calss="ex">
    <tr>
    <td colspan="3"> <img src="./img/favicon.png" class="logo"> <B>AdminTax | &nbsp; LIQUIDACIÓN CORRESPONDIENTE A: Licencia y salario vacacional <?php echo $reciboFecha;?></td><td class="cons"><b>RECIBO DE LICENCIA</td>
    </tr>
    <tr>
    <td width='48%'>
