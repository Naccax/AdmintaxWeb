<script>
    ...
    let toggle = button => {
    let element = document.getElementById("movil_info");
...
<body>
  ...
  <button type="button" class="btn btn-primary" onclick="toggle(this)"><?php 
          if (isset($movil[0]['Movil']))
            echo $movil[0]['Movil'];
          else
            echo "Selccionar Móvil";

          
          if (isset($_POST['Kilometros']))
            echo " Km recorridos: ".$_POST['Kilometros'];
    ...
    <div class="content">
      <form action="#" method="POST"><div id="movil_info"
      <?php
      if(isset($_POSt['Kilometros'])) 
      ...
      >
        ...
        if ((isset($_POST["KmEntrada"])) and (isset($_POST["KmSalida"]))) { ?>
        ...
        <div class="button">
          <input type="submit" value="Siguiente" id="action-button"  onclick="toggle(this)">
        </div>
      </form>
    </div>
  </div>
