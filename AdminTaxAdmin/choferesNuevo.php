...
<body>
  <div class="container">
    <div class="title">Nuevo Chofer</div>
    <div class="content">
      <form action="#" method="POST">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="C.I." name="CI" required >
          </div>

          <div class="input-box">
            <span class="details">Nombre</span>
            <input type="text" placeholder="Apellidos, Nombre" name="Nombre" required>
          </div>
          <div class="input-box">
            <span class="details">Patronal</span>
            <input type="text" placeholder="N° de conductors" name="Patronal" >
          </div>
          <div class="input-box">
            <span class="details">Celeritas</span>
            <input type="text" placeholder="N° de conductors" name="Celeritas" >
          </div>
          <div class="input-box">
            <span class="details">Direcci&oacute;n</span>
            <input type="text" placeholder="Direcci&oacute;n" name="Direccion" required>
          </div>
          <div class="input-box">
            <span class="details">Contacto</span>
            <input type="text" placeholder="091234567" name="contacto" required>
          </div>
          <div class="input-box">
            <span class="details">Contacto 2</span>
            <input type="text" placeholder="091234567"  name="contacto2">
          </div>
          <div class="input-box">
            <span class="details">Sueldo</span>
            <input type="number" placeholder="33%"  name="Sueldo">
          </div>
          <div class="input-box">
            <span class="details">Aporte</span>
            <input type="text" placeholder="21.1"  name="tipoAporte">
          </div>
          <div class="input-box">
            <span class="details">Retenci&oacute;n</span>
            <input type="text" placeholder="0" name="Retencion">
          </div>
          <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Nombre en Excel"  name="NombreEnPlanilla">
          </div>
          <div class="input-box">
            <span class="details">Hs Extra</span>
            <input type="checkbox" name="HsExtra" checked="true">
          </div>
        </div>
        <div class="button">
