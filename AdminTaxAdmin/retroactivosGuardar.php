...
{
  if ($_POST['id']!=""){
    $consulta="UPDATE `retroactivos` SET 
  ...
  {
    $sql="INSERT INTO `retroactivos` (Detalle,Monto,Fecha) VALUES ";
    $values="('".$_POST['Detalle']."','".$_POST['Monto']."','".$_POST['Fecha']."');";
    $sql=$sql.$values;
    Insert($sql);
  }
    header('location:RetroActivosTodos.php');    
}


if (isset($_GET['retroactivo']))
{
  $consulta="SELECT * FROM `retroactivos` WHERE Id=".$_GET['retroactivo'];
      ...
      <form action="#" method="POST">
        <div class="user-details">          
          ...
          <div class="input-box">
            ...
            <input type="datetime-local" <?php if (isset($doc[0]['Fecha'])) echo 'value="'.$doc[0]['Fecha'].'"'; ?> name="Fecha">
          </div>
