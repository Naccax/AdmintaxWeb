...
if (isset($_POST["LicenciasId"])){
  ...
  <table border="1" calss="ex">
      <tr>
      <td colspan="3"> <B>AdminTax | &nbsp; LIQUIDACIÓN CORRESPONDIENTEA SALARIO VACACIONAL Y LICENCIA <?php echo $anio[0].$leyenda; ?></td><td class="cons"><b>LICENCIA Y VACACIONAL</td>
      </tr>
      <tr>
      <td width='48%'>
