...
$sql="SELECT `hasta` FROM `licencias` WHERE `Id`=".$_POST["LicenciasId"];
$LicenciaAnio=ejecutarConsulta($sql);
$anio=explode("-",$LicenciaAnio[0]["hasta"]);
...
$sql="SELECT * FROM planilladetrabajo WHERE Fecha='".$_POST["fecha"]."' AND Concepto='Vacacional' AND ChoferID='".$_POST["ChoferID"]."' AND EmpresaID='".$_POST["EmpresaID"]."';";
...
$sql="UPDATE recibodetallerw SET 
Valor='".$_POST["LicenciaPorAportacion"]."', Monto='".$_POST["LicenciaPorAportacion"]."', Detalle = 'Licencia: ".$_POST["Comunes_Jornales"]." Jornales: ".round(($_POST["Comunes_Jornales"]*0.0664),0)." días' 
where Detalle LIKE'%Licencia%' and IdRs='".$rsid."'";
Insert($sql);

$temp=$_POST["TotalBruto"]*($descuntoJuvilatorio/100);
$temp=round($temp,2);
$sql="UPDATE recibodetallerw SET 
Valor='0', Monto='0' 
...
$totalRecibido=$_POST["TotalBruto"]+$_POST["LicenciaPorAportacion"];;
$totalBruto=$_POST["TotalBruto"]+$_POST["LicenciaPorAportacion"];
...
$sql = "SELECT * FROM `planilladetrabajo` WHERE `Id` = '".$rsid."';";
$planillaDeTrabajo=ejecutarConsulta($sql);

$sueldoBaseParaAportacion=0;
$leyenda=" <a href='choferesRecibosVacacional.php?id=".$planillaDeTrabajo[0]["Id"]."&chofer=".$_POST["ChoferID"]."&estado=".$planillaDeTrabajo[0]["LicenciaGozada"]."'>(No Gozada)</a>";
if($planillaDeTrabajo[0]["LicenciaGozada"]!="No")
{
  $leyenda=" <a href='choferesRecibosVacacional.php?id=".$planillaDeTrabajo[0]["Id"]."&chofer=".$_POST["ChoferID"]."&estado=".$planillaDeTrabajo[0]["LicenciaGozada"]."'>(Gozada)</a>";
  $sueldoBaseParaAportacion=$_POST["LicenciaPorAportacion"];
}


$descJubilatorio=round(($sueldoBaseParaAportacion*0.15),2);
$descFonasa=$descuntoJuvilatorio-15.1;
$descFonasaMonto=round(($sueldoBaseParaAportacion*($descFonasa/100)),2);
$descFrl=$sueldoBaseParaAportacion*0.00100;
$descFrl=round($descFrl,3);

$totalDescuentos=round(($sueldoBaseParaAportacion*($descuntoJuvilatorio/100)),2);

$totalRetenido=$retencion;

$totalDescuentos=$totalDescuentos+$retencion;
$totalRecibido=$totalBruto-$totalDescuentos;
...
<table border="1" calss="ex">
    <tr>
    <td colspan="3"> <img src="./img/favicon.png" class="logo"> <B>AdminTax | &nbsp; LIQUIDACIÓN CORRESPONDIENTEA SALARIO VACACIONAL Y LICENCIA <?php echo $anio[0].$leyenda; ?></td><td class="cons"><b>LICENCIA Y VACACIONAL</td>
    </tr>
    <tr>
    <td width='48%'>
    ...
    <td><table>
        ...
        <p align='right'>
        <b>Total Bruto:&nbsp;&nbsp;&nbsp; $<?php echo $totalBruto;?></b>
        </p>
        <!--
        <table>
    ...
    <td colspan="3" calss="td2">
        <table border="0">
            ...
            <tr><td>Total Para Aportación</td><td>$ <?php echo $sueldoBaseParaAportacion; ?></td></tr>
        </table>
        <br>
        <table border="0">
    ...
    <tr>
    <td colspan="2">Montevideo <?php echo $anio[0]; ?></td>
    </tr></tr>
    <tr>
...
$sql="UPDATE planilladetrabajo SET SueldoBaseParaAportacion='".$sueldoBaseParaAportacion."', TotalRecibido='".$totalRecibido."', RemuneracionTotal='".$sueldoBaseParaAportacion."', Descuentos='".$TotalDescuentos."', Comunes_Jornales='".$_POST["Comunes_Jornales"]."' WHERE Id='".$_GET["rsid"]."';";
Insert($sql);
?>
</table>
<a href="Index.php">Guardar y Salir</a>
