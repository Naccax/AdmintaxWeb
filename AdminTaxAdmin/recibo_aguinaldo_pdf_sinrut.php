...
$sql="SELECT * FROM empresa WHERE id=3";
...
$sql="SELECT * FROM planilladetrabajo WHERE Fecha='".$_POST["fecha"]."' AND Concepto='Aguinaldo SR' AND ChoferID='".$_POST["ChoferID"]."' AND EmpresaID='".$_POST["EmpresaID"]."';";
...
//if($temp[01]){}
$reciboFecha2=$meces[$temp[01]]." de ".$temp[0];
?>
...
<table border="1" calss="ex">
    <tr>
    <td colspan="3"> <img src="./img/favicon.png" class="logo"> <B>AdminTax | &nbsp; LIQUIDACIÓN CORRESPONDIENTE A AGUINALDO <?php echo $reciboFecha;?></td><td class="cons"><b>RECIBO DE AGUINALDO</td>
    </tr>
    <tr>
    <td width='48%'>
  ...
  </td><td colspan="3"><p align="center">La empresa a solicitud expresa del Trabajador, se deslinda de efectuar los aportes correspondientes a la Seguridad Social, quedando los mismos bajo su propia responsabilidad<br> 
        <br>Firma: _____________________________________________
