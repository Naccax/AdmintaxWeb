...
$consulta="Select * 
from 
planilladetrabajo,`periodosaguinaldo`,chofer 
where 
...
Truncate(sum(`planilladetrabajo`.Recaudacion),2) as Recaudacion,
...
periodosaguinaldo.id as id,
periodosaguinaldo.desde as desde,
        ...
        <tbody>
            <?php
                ...
                foreach($docs as $doc)
                {
                    ...
                    echo '
                    <td>
                        <form action="recibo_aguinaldo_pdf.php" method="post">
